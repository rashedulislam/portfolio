    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                <div class="profile-teaser media flex-column flex-lg-row">
                    ...
                    <div class="media-body">
                        ...
                        <div class="bio mb-4">I'm a software engineer specialised in backend development for complex scalable web apps. I write about software development on <a class="link-on-bg" href="/blog">my blog</a>. Want to know how I may help your project? Check out my project <a class="link-on-bg" href="/projects">portfolio</a> and <a class="link-on-bg" href="/resume">online resume</a>.
                        </div><!--//bio-->
                        <div class="mb-4">
                    ...
                    <img class="profile-image mb-3 mb-lg-0 ml-lg-5 mr-md-0" src="<?php echo get_template_directory_uri(); ?>/assets/images/profile-lg.jpg" alt="">
                </div>
            </div>
        ...
        <section class="overview-section p-3 p-lg-5">
            <div class="container">
                ...
                <div class="text-center py-3"><a href="services" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-right mr-2"></i>Services &amp; Pricing
            ...
            <div class="container">
                ...
                <div class="testimonial-carousel owl-carousel owl-theme">
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-1.png" alt="image"/>
                            </div>
                            <div class="meta">
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-2.png" alt="image"/>
                            </div>
                            <div class="meta">
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-3.png" alt="image"/>
                            </div>
                            <div class="meta">
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-4.png" alt="image"/>
                            </div>
                            <div class="meta">
                                <div class="name">James Lee</div>
                                <div class="info">Product Manager, Amazon</div>
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-5.png" alt="image"/>
                            </div>
                            <div class="meta">
                    ...
                    <div class="item">
                        ...
                        <div class="source-holder">
                            <div class="source-profile">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/clients/profile-6.png" alt="image"/>
                            </div>
                            <div class="meta">
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-1.jpg" alt="image">
                            <div class="card-body">
                                <h5 class="card-title"><a class="theme-link" href="blog">Top 3 JavaScript Frameworks</a></h5>
                                ...
                                <p class="mb-0"><a class="more-link" href="/blog">Read more &rarr;</a></p>
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-2.jpg" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-3.jpg" alt="image">
                            <div class="card-body">
