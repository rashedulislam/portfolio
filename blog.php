        ...
        <section class="blog-list px-3 py-5 p-md-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-4.jpg" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-5.jpg" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card blog-post-card">
                            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-post-thumb-card-6.jpg" alt="image">
                            <div class="card-body">
